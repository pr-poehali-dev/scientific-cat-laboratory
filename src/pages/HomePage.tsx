...
const FITIL_GREETINGS = [
  'А, снова вы. Присаживайтесь — наука ждать не будет.',
  ...
  'Наконец-то! Я уже начал думать, что мир решил отказаться от знаний. Рановато.',
  'Профессор Фитиль принимает. Будьте готовы учиться — отговорки не принимаются.',
];
